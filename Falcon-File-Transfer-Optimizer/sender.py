...
if __name__ == '__main__':
    ...
    parser.add_argument("--method", required=True, help="choose one of them : gradient, bayes, brute, probe")
    parser.add_argument("--thread", required=True, help="concurrency cc level")
